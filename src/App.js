...
const verifyTokenAPIURL = 'https://wurqy7fi5m.execute-api.us-east-1.amazonaws.com/DevEnvironment/verify';
  ...
  return (
    <div className="App">
      ...
      <div className="header">
        <div className="title">Healthcare App</div>
        <div className="links">
      ...
      <div className="content">
        <Switch>
          ...
          <PrivateRoute path="/dashboard" component={PremiumContent}/>
        </Switch>
      </div>
      </BrowserRouter>
    </div>
